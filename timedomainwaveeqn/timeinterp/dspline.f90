...
! Barnett needed this simpler version without allocation of output arrays:
...
!
  ...
  LOGICAL, SAVE :: first_call=.TRUE.
!
! for MEX output to matlab: (Barnett)
...
!
!  nc=jmax-jmin+1
! nc now input param, debug it...
!  write(str,*) 'nc=',nc,achar(10)
!  i = mexPrintf(str)
! Barnett added optional alloc allowing calling routine to have done it:
...
!
!  debug:
!  write(str,*) 'umat(jt,2)=',umat(jt,2),achar(10)
!  i = mexPrintf(str)
  END DO
!
